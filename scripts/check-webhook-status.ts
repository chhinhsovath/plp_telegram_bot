...
async function checkWebhookStatus() {
  ...
  const webhookUrl = `${env.NEXTAUTH_URL || 'https://telebot.openplp.com'}/api/telegram/webhook`;
  ...
  try {
    ...
    console.log('4. Check the logs at: https://telebot.openplp.com/api/telegram/webhook');
